  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {/* Bottom Section - Highlights & Bulk Orders */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="text-center mb-6">
              <h3 className="text-xl font-bold text-gray-900 mb-2">NEED BULK QUANTITIES?</h3>
              <p className="text-orange-600 font-medium mb-1">Amazing Deals on Bulk Orders!</p>
              <p className="text-gray-600 text-sm">Perfect for Gifts and Return Gifts</p>
            </div>
