      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-500 to-orange-600 text-white px-6 py-2 rounded-full mb-4">
            ...
            <span className="font-semibold">Backlight Portrait Frame</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-3">
            Customize Your Backlight Portrait
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Upload your favorite photo and see it glow in a beautiful backlit portrait frame
          </p>
        </div>
                ...
                />
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center h-full text-gray-400">
                      ...
                      <p className="text-sm text-center px-4">
                        Upload a photo to see your backlight portrait preview
                      </p>
                    </div>
                  )}
                </div>
