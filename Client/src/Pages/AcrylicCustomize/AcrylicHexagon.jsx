...
import { Upload, X, Image, Eye, Sparkles, CheckCircle2, Hexagon } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-2 rounded-full mb-4">
            ...
            <span className="font-semibold">Acrylic Hexagon Frame</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-3">
            Customize Your Acrylic Hexagon
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Upload your favorite photo and see it come to life in a beautiful hexagonal acrylic frame
          </p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <div className="p-8">
              <div className="relative w-full flex justify-center">
                <div className="hexagon-frame w-60 h-60 sm:w-72 sm:h-72 md:w-80 md:h-80 relative shadow-2xl">
                {photoData ? (
                  <img
                    src={photoData.url}
                    alt="Hexagon Preview"
                  ...
                  />
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-gray-400">
                      ...
                      <p className="text-sm text-center px-4">
                        Upload a photo to see your hexagon preview
                      </p>
                    </div>
                  )}
                </div>
