      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-2 rounded-full mb-4">
            ...
            <span className="font-semibold">Landscape Acrylic Frame</span>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
              ...
              <div className="p-8">
                <div className="flex flex-col items-center justify-center space-y-6">
                  <div className="w-full max-w-md mx-auto text-center p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-200">
                  ...
                  <div className="relative w-full max-w-lg mx-auto">
                    <div
                      className="relative mx-auto bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl overflow-hidden shadow-2xl transition-all duration-500 mask-landscape"
                      style={{
                      ...
                      <button
                        ...
                        className={`px-4 py-3 rounded-xl border-2 text-sm font-medium transition-all duration-200 ${
                          selectedSize?.label === sizeObj.label
                            ...
                            : "bg-white text-gray-800 border-gray-300 hover:border-indigo-400 hover:shadow-md"
                        }`}
                      >
