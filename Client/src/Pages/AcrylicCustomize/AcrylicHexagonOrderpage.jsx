...
import { Sparkles, Package, Ruler, Box, CheckCircle2, Loader2, Hexagon } from "lucide-react";
...
const AcrylicHexagonOrderPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50/30 to-indigo-50/30 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 to-indigo-600 text-white px-6 py-2 rounded-full mb-4">
            <Hexagon className="w-5 h-5" />
            <span className="font-semibold">Hexagon Acrylic Frame</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-3">
            Complete Your Order
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Select your preferred size and thickness to see your custom hexagon frame preview
          </p>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
              ...
              <div className="p-8">
                <div className="flex flex-col items-center justify-center space-y-6">
                  <div className="w-full max-w-md mx-auto text-center p-4 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl border border-purple-200">
                  ...
                  <div className="relative w-full max-w-md mx-auto">
                    <div
                      className="relative mx-auto hexagon-frame transition-all duration-500"
                      style={{
                    ...
                    >
                      <div className="w-full h-full overflow-hidden" style={{ clipPath: "polygon(25% 6.7%, 75% 6.7%, 100% 50%, 75% 93.3%, 25% 93.3%, 0% 50%)" }}>
                        <img
                          src={photoData?.url}
                          alt="Frame Preview"
                  ...
                  <div className="text-center p-4 bg-green-50 rounded-xl border border-green-200">
                    <p className="text-sm text-gray-700">
                      ...
                      <span className="font-bold text-green-700">{selectedSize?.label}</span> hexagon frame
                      {selectedThickness && (
                ...
                <div className="space-y-4 pt-4 border-t border-gray-200">
                  <div className="flex items-center gap-4">
                    ...
                    <input
                      ...
                      className="w-24 px-4 py-2 border-2 border-gray-300 rounded-lg focus:outline-purple-600 focus:ring-2 focus:ring-purple-200 font-semibold text-center"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-6 py-4 rounded-xl flex items-center justify-center gap-3 font-semibold transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                  >
                    {loading ? (
                      <>
