...
const AcrylicSquareOrderpage = () => {
  ...
  // Calculate frame dimensions from size label
  ...
  // Get border width based on thickness
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-2 rounded-full mb-4">
            ...
            <span className="font-semibold">Square Acrylic Frame</span>
          </div>
              ...
              <div className="p-8">
                <div className="flex flex-col items-center justify-center space-y-6">
                  ...
                  <div className="relative w-full max-w-lg mx-auto">
                    <div
                      className="relative mx-auto bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl overflow-hidden shadow-2xl transition-all duration-500"
                      style={{
