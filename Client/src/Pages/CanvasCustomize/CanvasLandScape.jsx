      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-2 rounded-full mb-4">
            ...
            <span className="font-semibold">Canvas Landscape Frame</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-3">
            Customize Your Canvas Landscape
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Upload your favorite photo and see it come to life in a beautiful canvas landscape frame
          </p>
        </div>
                ...
                />
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-gray-400">
                      ...
                      <p className="text-sm text-center px-4">
                        Upload a photo to see your canvas landscape preview
                      </p>
                    </div>
                  )}
                </div>
