              ...
              <div className="p-8">
                <div className="flex flex-col items-center justify-center space-y-6">
                  ...
                  <div className="relative w-full max-w-lg mx-auto">
                    <div
                      className="relative mx-auto bg-gradient-to-br from-amber-100 to-orange-100 rounded-2xl overflow-hidden shadow-2xl transition-all duration-500 mask-portrait"
                      style={{
                  ...
                  <div className="text-center p-4 bg-indigo-50 rounded-xl border border-indigo-200">
                    <p className="text-sm text-gray-700">
                      ...
                      <span className="font-bold text-indigo-700">{selectedSize?.label}</span> portrait canvas
                      {selectedThickness && (
