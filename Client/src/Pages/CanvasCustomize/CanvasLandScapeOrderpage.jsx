...
const CanvasLandScapeOrderpage = () => {
  ...
  const [product, setProduct] = useState({
    ...
    sizes: [
      { label: "10x8", price: 499, original: 699 },
      { label: "16x12", price: 699, original: 899 },
      { label: "20x16", price: 899, original: 1199 },
    ],
  ...
  const frameDims = selectedSize ? getFrameDimensions(selectedSize.label) : { width: 10, height: 8 };
  const borderWidth = selectedThickness ? getBorderWidth(selectedThickness) : "10px";
  const aspectRatio = selectedSize ? getAspectRatio(selectedSize.label) : 1.25;

  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-amber-50/30 to-orange-50/30 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-500 to-orange-600 text-white px-6 py-2 rounded-full mb-4">
            <Sparkles className="w-5 h-5" />
            <span className="font-semibold">Landscape Canvas Frame</span>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
              ...
              <div className="p-8">
                <div className="flex flex-col items-center justify-center space-y-6">
                  <div className="w-full max-w-md mx-auto text-center p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl border border-amber-200">
                  ...
                  <div className="relative w-full max-w-lg mx-auto">
                    <div
                      className="relative mx-auto bg-gradient-to-br from-amber-100 to-orange-100 rounded-2xl overflow-hidden shadow-2xl transition-all duration-500 mask-landscape"
                      style={{
                  ...
                  <div className="text-center p-4 bg-indigo-50 rounded-xl border border-indigo-200">
                    <p className="text-sm text-gray-700">
                      <span className="font-semibold">Preview:</span> Your photo will be printed on a{" "}
                      <span className="font-bold text-indigo-700">{selectedSize?.label}</span> landscape canvas
                      {selectedThickness && (
                      ...
                      <button
                        ...
                        className={`px-4 py-3 rounded-xl border-2 text-sm font-medium transition-all duration-200 ${
                          selectedSize?.label === sizeObj.label
                            ...
                            : "bg-white text-gray-800 border-gray-300 hover:border-amber-400 hover:shadow-md"
                        }`}
                      >
                ...
                <div className="space-y-4 pt-4 border-t border-gray-200">
                  <div className="flex items-center gap-4">
                    ...
                    <input
                      ...
                      className="w-24 px-4 py-2 border-2 border-gray-300 rounded-lg focus:outline-amber-600 focus:ring-2 focus:ring-amber-200 font-semibold text-center"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white px-6 py-4 rounded-xl flex items-center justify-center gap-3 font-semibold transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                  >
                    {loading ? (
                      <>
