...
const Frames = () => {
  ...
  const renderShape = () => {
    if (!userImage) return <p className="text-gray-500">Upload image to see preview</p>;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 p-6">
      <div className="text-center mb-10">
        <h1 className="text-4xl md:text-5xl font-extrabold text-blue-600 drop-shadow-lg mb-4">
          🖼️ Frame Customizer
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Create your perfect framed photo. Choose shape, color, style, and size.
        </p>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4 max-w-6xl mx-auto">
          {[
            ...
            <div
              key={i}
              className="flex flex-col items-center justify-center bg-white p-4 rounded-xl border border-gray-200 shadow-lg w-36 hover:scale-105 transition-all duration-300 hover:shadow-xl"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-7xl mx-auto">
        ...
        <div className="bg-white p-8 rounded-3xl shadow-2xl border border-blue-200">
          ...
          <div className="mt-6">
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
            />
            {userImage && (
              <div className="mt-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                ...
                <button
                  ...
                  className="text-red-600 underline text-sm mt-1 flex items-center gap-1 hover:text-red-700"
                >
                  <MdClose />
                  Remove Image
                </button>
        ...
        <div className="bg-white p-6 rounded-3xl shadow-xl border border-blue-200">
          ...
          <div className="space-y-6">
            {/* Shape Selection */}
            <div>
              <label className="block text-lg font-semibold text-gray-800 mb-3">Select Shape</label>
              <select
                ...
                className="block border-2 border-gray-300 w-full p-3 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
              >
            ...
            {selectedShape && (
              <div>
                <label className="block text-lg font-semibold text-gray-800 mb-3">Select Color</label>
                <select
                  value={selectedColor}
                  onChange={(e) => {
            ...
            {selectedFrameImage && (
              <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4">
                ...
                <div className="flex gap-4 items-center">
                  ...
                  />
                  <div>
                    <h4 className="font-semibold text-blue-900">{selectedFrameImage.title}</h4>
                    <p className="text-sm text-blue-700">Color: {selectedColor}</p>
                    <p className="text-sm text-blue-700">Style: {selectedStyle}</p>
                    {selectedSize && (
                      <p className="text-sm text-blue-700">Size: {selectedSize.label} - ₹{selectedSize.amount}</p>
                    )}
                  </div>
                </div>
                <p className="text-xs text-blue-600 mt-2">
                  💡 This frame design will be used for your photo. You can change it by selecting a different color above.
                </p>
              </div>
            )}
            ...
            {selectedColor && getAvailableStyles().length > 1 && (
              <div>
                ...
                <div className="mt-4">
                  ...
                  >
                    {expandedStyles[selectedColor] ? <MdExpandLess /> : <MdExpandMore />}
                    {expandedStyles[selectedColor] ? "Hide" : "Show"} Style Previews
                  </button>

                  {expandedStyles[selectedColor] && (
                    <div className="mt-3 grid grid-cols-2 gap-3">
                      {getAvailableStyles().map((style, styleIdx) => (
                        <div key={styleIdx} className="border border-gray-200 rounded-lg p-3 bg-gray-50">
                          <h4 className="font-semibold text-gray-800 text-sm mb-2">{style.styleName}</h4>
                          <div className="grid grid-cols-2 gap-2">
                            {style.frameImages.slice(0, 2).map((frame, frameIdx) => {
                          ...
                          {style.frameImages.length > 2 && (
                            <p className="text-xs text-gray-500 mt-1">+{style.frameImages.length - 2} more frames</p>
                          )}
                        </div>
                      ))}
                    </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {getAvailableFrameImages().map((frame, frameIdx) => (
                    <div key={frameIdx} className="border-2 border-gray-200 rounded-xl p-4 bg-white hover:border-blue-400 transition-all duration-300">
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold text-lg text-gray-800 mb-2">{frame.title}</h4>
            ...
            {selectedFrameImage && (
              <div>
                <label className="block text-lg font-semibold text-gray-800 mb-3">Select Size</label>
                <select
            ...
            {selectedSize && (
              <div>
                ...
                <input
                  ...
                  className="border-2 border-gray-300 mt-2 p-3 w-full rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                />
              </div>
            )}

            {/* Order Summary */}
            {selectedShape && selectedColor && selectedStyle && selectedFrameImage && selectedSize && (
              <div className="mt-6 p-6 bg-gradient-to-r from-blue-50 to-green-50 rounded-2xl border-2 border-blue-200 shadow-lg">
                <h3 className="text-xl font-bold text-center text-blue-800 mb-4 flex items-center justify-center gap-2">
                  <MdListAlt />
                  Order Summary
                </h3>
            ...
            {selectedSize && (
              <div className="flex justify-center mt-6">
                <button
                  ...
                  className="bg-gradient-to-r from-green-600 to-blue-600 text-white px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 flex items-center gap-3 text-lg font-semibold"
                >
